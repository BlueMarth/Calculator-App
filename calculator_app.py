...
btn_0.grid(row = 7, column = 1, sticky = 'nesw', ipadx=4, ipady=4)
btn_1.grid(row = 6, column = 0, sticky = 'nesw', ipadx=4, ipady=4)
btn_2.grid(row = 6, column = 1, sticky = 'nesw', ipadx=4, ipady=4)
btn_3.grid(row = 6, column = 2, sticky = 'nesw', ipadx=4, ipady=4)
btn_4.grid(row = 5, column = 0, sticky = 'nesw', ipadx=4, ipady=4)
btn_5.grid(row = 5, column = 1, sticky = 'nesw', ipadx=4, ipady=4)
btn_6.grid(row = 5, column = 2, sticky = 'nesw', ipadx=4, ipady=4)
btn_7.grid(row = 4, column = 0, sticky = 'nesw', ipadx=4, ipady=4)
btn_8.grid(row = 4, column = 1, sticky = 'nesw', ipadx=4, ipady=4)
btn_9.grid(row = 4, column = 2, sticky = 'nesw', ipadx=4, ipady=4)

btn_negate.grid(row = 7, column = 0, sticky = 'nesw', ipadx=4, ipady=4)
btn_dot.grid(row = 7, column = 2, sticky = 'nesw', ipadx=4, ipady=4)
btn_exe.grid(row = 7, column = 3, sticky = 'nesw', ipadx=4, ipady=4)
btn_plus.grid(row = 6, column = 3, sticky = 'nesw', ipadx=4, ipady=4)
btn_minus.grid(row = 5, column = 3, sticky = 'nesw', ipadx=4, ipady=4)
btn_times.grid(row = 4, column = 3, sticky = 'nesw', ipadx=4, ipady=4)
btn_divide.grid(row = 3, column = 3, sticky = 'nesw', ipadx=4, ipady=4)
btn_percent.grid(row = 3, column = 2, sticky = 'nesw', ipadx=4, ipady=4)
btn_parentheses.grid(row = 3, column = 1, sticky = 'nesw', ipadx=4, ipady=4)
btn_clear.grid(row = 3, column = 0, sticky = 'nesw', ipadx=4, ipady=4)
